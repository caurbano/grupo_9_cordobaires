...
const Sidebar = () => {
    return (
        <div className="sidebar">
            ...
            <ul className='mobile'>
                <li>
                    <NavLink to={'/'} className='text-light rounded py-2 px-3 w-100' activeClassName='active'><FaIcons.FaHome className='me-2'/></NavLink>
                </li>
                <li>
                    <NavLink to={'/products'} className='text-light rounded py-2 px-3 w-100' activeClassName='active'><FaIcons.FaShoppingBag className='me-2'/></NavLink>
                </li>
                <li>
                    <NavLink to={'/users'} className='text-light rounded py-2 px-3 w-100' activeClassName='active'><FaIcons.FaUserFriends className='me-2'/></NavLink>
                </li>
                <li>
                    <NavLink to={'/categories'} className='text-light rounded py-2 px-3 w-100' activeClassName='active'><FaIcons.FaSlidersH className='me-2'/></NavLink>
                </li>
                <li>
                    <NavLink to={'/statistics'} className='text-light rounded py-2 px-3 w-100' activeClassName='active'><FaIcons.FaChartBar className='me-2'/></NavLink>
                </li>
            </ul>
